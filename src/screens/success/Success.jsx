...
import Vector from '../../assets/success.jpg';
import Vec from '../../assets/check.png';
  ...
  return (
    <div className=' top-0 left-0 right-0 header shadow-md z-50'> 
            ...
            <Row>
                    ...
                    <img src={Vec} alt="" />
                    <h1 className='airtime-header text-3xl font-bold text-center'>Transcation Successful!</h1>
                    <h6 className='text-center'>Your transcation has been <br />processed Successfully.</h6>
