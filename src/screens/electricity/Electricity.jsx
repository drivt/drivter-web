...
import EKEDC from '../../assets/ekedc.jpeg';
...
return (
    ...
    <Row>
            ...
            <h1 className='airtime-header text-3xl font-bold text-center'>Electricity</h1>
            ...
            <Input type="select" name="select" id="exampleSelect" className='mb-4 Ph'>
              ...
              <option>EKEDC</option>
              <option>IKEJA Electricity</option>
              <option>IBEDC</option>
              <option>KANO Electricty</option>
            </Input>
          </FormGroup>

          <div className="elect"><img src={EKEDC} alt="" />
          </div>

          <h6>Kindly input your details:</h6>

          <Form.Group>
          <Form.Control type='tel' placeholder="Meter Number" className='mb-4 Ph' required/>
